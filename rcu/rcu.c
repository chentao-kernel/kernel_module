/*
 * Author: Chen Tao
 * Create: Mon Nov 07 23:26:10 2022
 */
...
static void book_reclaim_callback(struct rcu_head *rcu) {
	 ...
	 * rcu注册的callback函数在rcu软中断上下文
	[Mon Nov  7 23:45:05 2022] Call Trace:
	[Mon Nov  7 23:45:05 2022]  dump_stack+0x66/0x8b
	[Mon Nov  7 23:45:05 2022]  book_reclaim_callback+0x2e/0x40 [rcu]
	[Mon Nov  7 23:45:05 2022]  rcu_process_callbacks+0x1e4/0x4c0
	[Mon Nov  7 23:45:05 2022]  __do_softirq+0x108/0x2b8
	[Mon Nov  7 23:45:05 2022]  run_ksoftirqd+0x26/0x40
	[Mon Nov  7 23:45:05 2022]  smpboot_thread_fn+0xfe/0x150
	[Mon Nov  7 23:45:05 2022]  kthread+0xf5/0x130
	[Mon Nov  7 23:45:05 2022]  ? sort_range+0x20/0x20
	[Mon Nov  7 23:45:05 2022]  ? kthread_create_worker_on_cpu+0x70/0x70
	[Mon Nov  7 23:45:05 2022]  ret_from_fork+0x1f/0x30
	*/
...
static int return_book(int id, int async) {
	...
	*/
	...
	// tao 不去rcu_unlock，保持非静止状态
	/*
	[Tue Nov  8 00:10:53 2022] Call Trace:
	[Tue Nov  8 00:10:53 2022]  <IRQ>
	[Tue Nov  8 00:10:53 2022]  dump_stack+0x66/0x8b
	[Tue Nov  8 00:10:53 2022]  book_reclaim_callback+0x2e/0x40 [rcu]
	[Tue Nov  8 00:10:53 2022]  rcu_process_callbacks+0x1e4/0x4c0
	[Tue Nov  8 00:10:53 2022]  ? enqueue_hrtimer+0x3a/0x90
	[Tue Nov  8 00:10:53 2022]  __do_softirq+0x108/0x2b8
	[Tue Nov  8 00:10:53 2022]  irq_exit+0xf4/0x100
	[Tue Nov  8 00:10:53 2022]  smp_apic_timer_interrupt+0x68/0x120
	[Tue Nov  8 00:10:53 2022]  apic_timer_interrupt+0xf/0x20
	[Tue Nov  8 00:10:53 2022]  </IRQ>
	[Tue Nov  8 00:10:53 2022] RIP: 0033:0x7fdee7e62f4c	
	*/
	rcu_read_unlock();
